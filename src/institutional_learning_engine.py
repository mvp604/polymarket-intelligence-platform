"""
Polymarket Institutional Learning Engine v1.1
...
def build_observations(
    ...
    for row in history_rows:
        ...
        decision_success: int | None = None

        if actual_result is not None:
            if decision_action == "BUY":
                decision_success = actual_result

            elif decision_action == "AVOID":
                decision_success = (
                    1 - actual_result
                )

        is_correct = decision_success
        ...
        brier_score = (
            ...
            if decision_success is not None
            else None
        )
